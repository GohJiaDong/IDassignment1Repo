/*Toggle between showing and hiding cart*/
function openCart() {
...
function checkout () {
  alert("Merchandise purchase successful!");
  itemlist = [];
  pricelist = [];
  totalcost = 0;

  document.getElementById("itemqty").innerHTML = "Quantity:<br>0";
  document.getElementById("grandtotal").innerHTML = "Grand Total:<br>-";
  /* Update the cart */
  var target3 = document.querySelector(".cart");
  var target4 = document.querySelectorAll(".cartitem");
  for (let i = 1; i < target4.length; i++)
  {
    target3.removeChild(target4[i]); 
  }
  /* Update the cart summary */
};
